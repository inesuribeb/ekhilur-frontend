...
function NuevoMenu() {
    ...
    const getLatestValue = (array, valueKey) => {
        ...
        const sorted = [...array].sort((a, b) => parseFloat(b.Mes) - parseFloat(a.Mes));
    ...
    const getChartData = (flujoMensual) => {
        ...
        return flujoMensual
            .slice(-4)
            .map(item => ({
                month: monthTranslations[language][Math.floor(safeParseFloat(item.Mes))] || '',
                ...
                <div className="mobile-content">
                    ...
                    <div className="mobile-second-line">
                        <div className="mobile-column1-line2">
                            <p>{formatNumber(getLatestValue(monthlyAverageSpending, 'Gasto_Medio_Mensual'))} EUR</p>
                            <p>{translate.averageSpending[language]}</p>
                        </div>

                        <div className="mobile-column2-line2">
                            <p>{formatNumber(getLatestValue(monthlySavingsAverage, 'Ahorro_Medio_Mensual'))} EUR</p>
                    ...
                    <div className="mobile-third-line">
                        ...
                        <p>{formatNumber(totalOperationsData?.['Número total de operaciones'])} {translate.purchasesIn[language]}</p>
                        <p>{formatNumber(totalOperationsData?.['Importe total (€)'])} {translate.paidWith[language]}</p>
                    </div>
